          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl opacity-90 max-w-2xl mx-auto px-4">
                Access our comprehensive library of educational books written by industry experts. 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto px-4">
                Learn from industry professionals and experienced educators who bring real-world knowledge to every page.
              </p>
            </div>
            
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
              {[...new Set(BOOKS.map(book => book.author))].slice(0, 4).map((author) => {
                ...
                return (
                  <div key={author} className="text-center">
                    ...
                    <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">{author}</h3>
                    <p className="text-xs sm:text-sm text-gray-600 mb-2">{authorBooks.length} Books</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="py-12 sm:py-16 bg-secondary-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl opacity-90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
              Download our books instantly and access expert knowledge anytime, anywhere. 
              Perfect for self-paced learning and reference.
            </p>
